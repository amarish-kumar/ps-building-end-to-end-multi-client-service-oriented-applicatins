...
namespace CarRental.Client.Proxies
{
    ...
    public class RentalClient : UserClientBase<IRentalService>, IRentalService
    {
        ...
        public void AcceptCarReturnAsync(int carId)
        {
            Channel.AcceptCarReturnAsync(carId);
        }
        ...
        {
            Channel.CancelReservationAsync(reservationId);
        }
        ...
        public void ExecuteRentalFromReservationAsync(int reservationId)
        {
            Channel.ExecuteRentalFromReservationAsync(reservationId);
        }
